...
srun -N 1 -n 1 -c $cores -o base.out --open-mode=append ./main_wrapper.sh --block-type 0 --batch-size 8 --dm 192 --h 6 --N 2 --dataset stories --filepath base.csv & #--vocab-size 50258 &
