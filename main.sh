...
srun -N 1 -n 1 -c $cores -o base.out --open-mode=append ./main_wrapper.sh --block-type 0 --block-size 256 --batch-size 2 --dm 512 --h 16 --N 8 --lr 5e-4 --dataset stories --filepath base.csv & #--vocab-size 50258 &
