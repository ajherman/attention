...
srun -N 1 -n 1 -c $cores -o base.out --open-mode=append ./main_wrapper.sh --block-type 0 --block-size 100 --batch-size 8 --dm 384 --h 6 --N 8 --dataset stories --filepath base.csv & #--vocab-size 50258 &
